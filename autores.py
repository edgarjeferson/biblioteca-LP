...
class AutoresApp(ttk.Frame):
    ...
    def open_add_autor_window(self):
        ...
        ttk.Label(form_frame, text="Nombres:").grid(row=0, column=0, padx=5, pady=5)
        nombres_entry = ttk.Entry(form_frame)
        nombres_entry.grid(row=0, column=1, padx=5, pady=5)

        ttk.Label(form_frame, text="Apellidos:").grid(row=1, column=0, padx=5, pady=5)
        apellidos_entry = ttk.Entry(form_frame)
        apellidos_entry.grid(row=1, column=1, padx=5, pady=5)

        ttk.Label(form_frame, text="DNI:").grid(row=2, column=0, padx=5, pady=5)
        dni_entry = ttk.Entry(form_frame)
        dni_entry.grid(row=2, column=1, padx=5, pady=5)

        ttk.Label(form_frame, text="Modalidad:").grid(row=3, column=0, padx=5, pady=5)
        modalidad_entry = ttk.Entry(form_frame)
        modalidad_entry.grid(row=3, column=1, padx=5, pady=5)

        ttk.Label(form_frame, text="Autorescol:").grid(row=4, column=0, padx=5, pady=5)
        autorescol_entry = ttk.Entry(form_frame)
        autorescol_entry.grid(row=4, column=1, padx=5, pady=5)
    ...
    def add_autor(self, nombres, apellidos, dni, modalidad, autorescol, window):
        if nombres and apellidos and dni and modalidad:
            self.execute_query('''
