...
class CategoriasApp(ttk.Frame):
    ...
    def open_add_window(self):
        ...
        ttk.Label(form_frame, text="Nombre Categoría:").grid(row=0, column=0, padx=5, pady=5)
        nombre_categoria_entry = ttk.Entry(form_frame)
        nombre_categoria_entry.grid(row=0, column=1, padx=5, pady=5)

        ttk.Label(form_frame, text="Ubicación:").grid(row=1, column=0, padx=5, pady=5)
