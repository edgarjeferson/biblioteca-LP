...
class LibrosAutoresApp(ttk.Frame):
    ...
    def open_add_window(self):
        ...
        ttk.Label(form_frame, text="ID Libro:").grid(row=0, column=0, sticky=tk.W)
        idlibro_entry = ttk.Entry(form_frame)
        idlibro_entry.grid(row=0, column=1, sticky=tk.EW)

        ttk.Label(form_frame, text="ID Autor:").grid(row=1, column=0, sticky=tk.W)
        idautor_entry = ttk.Entry(form_frame)
        idautor_entry.grid(row=1, column=1, sticky=tk.EW)
